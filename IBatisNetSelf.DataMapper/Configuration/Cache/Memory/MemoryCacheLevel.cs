...
namespace IBatisNetSelf.DataMapper.Configuration.Cache.Memory
{
    ...
    {
        #region Fields
        private static Hashtable cacheLevelMap = new Hashtable();
        ...
        static MemoryCacheLevel()
        {
            ...
            cacheLevelMap[Weak.ReferenceType] = Weak;
            cacheLevelMap[Strong.ReferenceType] = Strong;
        }
        #endregion
        ...
        {
            MemoryCacheLevel cacheLevel = (MemoryCacheLevel)cacheLevelMap[referenceType];
            if (cacheLevel == null)
            {
