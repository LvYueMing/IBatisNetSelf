...
namespace IBatisNetSelf.DataMapper.Commands
{
    ...
    {
        private IDataReader innerDataReader = null;
        private RequestScope request = null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DataReaderDecorator"/> class.
        /// </summary>
        /// <param name="aDataReader">The data reader.</param>
		/// <param name="aRequest">The request scope</param>
		public DataReaderDecorator(IDataReader aDataReader, RequestScope aRequest)
        {
            this.innerDataReader = aDataReader;
        ...
        {
            this.request.MoveNextResultMap();
