...
namespace IBatisNetSelf.DataMapper.Exceptions
{
    /// <summary>
    /// The DataMapperException is thrown when an error in the SqlMapper component occurs.
    /// </summary>
    [Serializable]
    public class DataMapperException : IBatisNetSelfException
    {
        /// <summary>
        ...
        /// </remarks>
        public DataMapperException() : base("IBatisNetSelf DataMapper component caused an exception.") { }
        ...
        /// </param>
        public DataMapperException(Exception ex) : base("IBatisNetSelf DataMapper component caused an exception.", ex) { }
